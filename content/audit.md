...
<div class="a-step" id="s11">
  ...
  <div class="a-nav"><button class="a-back" onclick="back(11)">Back</button><span class="a-count">12 / 12</span><button class="a-next" id="n11" disabled onclick="runAudit()">Get my AI audit</button></div>
</div>
...
<div class="results" id="results">
  ...
  <div class="r-content" id="r-content">
    ...
    <div class="ai-box">
      <div class="ai-label">Your personalised audit by Claude AI</div>
...
function next(q){document.getElementById('s'+q).classList.remove('active');document.getElementById('s'+(q+1)).classList.add('active');document.getElementById('prog').style.width=Math.round(((q+2)/13)*100)+'%';window.scrollTo(0,0);}
