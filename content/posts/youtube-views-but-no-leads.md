...
[params]
  ...
  [[params.faq]]
    question = "Why am I getting YouTube views but no leads?"
    answer = "It's almost always one of three things: you're attracting the wrong audience for your offer, the video has no clear conversion mechanism tied to a specific next step, or you're tracking the wrong metrics and optimizing for views instead of the actions that actually matter. Fixing the right one depends on correctly diagnosing which is actually happening."
  [[params.faq]]
    question = "Is 'Subscribe' a good call-to-action for lead generation?"
    answer = "No. Subscribe grows your channel, not your pipeline. A lead-generation video needs a call-to-action tied to a specific lead capture mechanism — a guide, a tool, a short assessment, a booked call — not a request to follow your content."
  [[params.faq]]
    question = "Where should I put my call-to-action link so people actually click it?"
    answer = "The first line of your video description is the only line most viewers see before they have to click 'show more,' so that's where your link needs to live, not buried three paragraphs down. Say the same call-to-action out loud in the video too — don't rely on the description alone."
  [[params.faq]]
    question = "How do I know if my views but no leads problem is an audience problem or a conversion problem?"
...
If you want a second set of eyes on which of the three is actually happening on your channel, [book a 1-on-1 call](https://selar.com/74i4823703) and we'll walk through your last ten videos together.
